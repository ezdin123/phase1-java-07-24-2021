...
public class BankOperation {
	...
	public static void main(String[] args) {
		String[] usernames = { "tady afro", "jacky fege", "alemu  tedela", "Rajan Ram", "Robert Kim" };
		...
		findUserId(usernames, userIds, balances, userId);
		}
	}

	private static void findUserId(String[] usernames, int[] userIds, double[] balances, int userId) {
		int match = 0;
